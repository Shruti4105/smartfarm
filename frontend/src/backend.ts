...
export class Backend implements backendInterface {
    ...
    async addCropListing(arg0: string, arg1: number, arg2: number, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addCropListing(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async addStoreItem(arg0: string, arg1: number, arg2: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addStoreItem(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async analyzeSoilImage(arg0: Uint8Array): Promise<SoilAnalysisResult> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeSoilImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkout(arg0: Array<StoreItem>, arg1: number, arg2: PaymentMethod): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async getCropListingsByLocation(arg0: string): Promise<Array<CropListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCropListingsByLocation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSmartCropAdvisory(arg0: CropAdvisoryParams): Promise<CropRecommendation> {
        if (this.processError) {
            try {
                const result = await this.actor.getSmartCropAdvisory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
